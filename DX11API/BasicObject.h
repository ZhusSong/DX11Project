...
namespace BasicObject
{
    ...
    MeshData<VertexType, IndexType> CreatePlane(const DirectX::XMFLOAT2& center, const DirectX::XMFLOAT2& scale, const DirectX::XMFLOAT4& color = { 1.0f, 1.0f, 1.0f, 1.0f });
    template<class VertexType = VertexPosTex, class IndexType = DWORD>
    MeshData<VertexType, IndexType> CreatePlane(float centerX = 0.0f, float centerY = 0.0f, float scaleX = 0.5f, float scaleY = 0.5f, const DirectX::XMFLOAT4& color = { 1.0f, 1.0f, 1.0f, 1.0f });
...
namespace BasicObject
{
    ...
    template<class VertexType, class IndexType>
    inline MeshData<VertexType, IndexType> CreatePlane(float centerX, float centerY, float scaleX, float scaleY, const DirectX::XMFLOAT4& color)
    {
        using namespace DirectX;
    ...
    template<class VertexType, class IndexType>
    inline MeshData<VertexType, IndexType> CreateSprite(float width, float depth, float texU, float texV, const DirectX::XMFLOAT4& color)
    {
        using namespace DirectX;
