...
void Transform::Translate(const DirectX::XMFLOAT3& direction, float distance)
{
    XMVECTOR directionVec = XMVector3Normalize(XMLoadFloat3(&direction));
    XMVECTOR newPosition = XMVectorMultiplyAdd(XMVectorReplicate(distance), directionVec, XMLoadFloat3(&m_Position));
